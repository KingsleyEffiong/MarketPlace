    ...
    >
      <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center py-5 px-6 md:px-10 transition-all duration-300">
        ...
        <motion.ul
          ...
          className="hidden md:flex flex-wrap gap-6 items-center text-gray-600 font-medium text-[16px] px-3"
        >
          <Link
            href="/"
          ...
          {/* <<-- FIX: make this absolute so it resolves from root, not relative to current path */}
          <Link
            href="/buyer/products"
            className="cursor-pointer hover:text-black transition-colors"
          >
        ...
        <motion.div
          ...
          className="hidden lg:flex relative flex-1 justify-center mx-4 max-w-lg"
        >
          <Search className="w-[14px] h-[14px] text-gray-800 absolute top-1/2 left-3 -translate-y-1/2" />
          <Input
            placeholder="Search products..."
            className="w-full border border-gray-300 pl-10 text-[16px] text-black bg-white/70 backdrop-blur-sm focus:ring-1 focus:ring-gray-400 transition-all duration-200"
          />
        </motion.div>
        ...
        >
          ...
          <div className="flex gap-4 items-center text-gray-600 font-medium text-[16px]">
            ...
            >
              <Button
                className="group relative overflow-hidden bg-indigo-600 text-white px-6 py-2 rounded-full flex items-center gap-2 shadow-[0_4px_20px_rgba(99,102,241,0.35)] hover:shadow-[0_4px_25px_rgba(99,102,241,0.5)] transition-all duration-300"
      ...
      {menuOpen && (
        <motion.div
          ...
          className="md:hidden flex flex-col gap-6 px-6 py-6 bg-white/80 backdrop-blur-lg border-t border-gray-200 shadow-[0_8px_25px_rgba(0,0,0,0.08)] text-gray-700 font-medium text-[16px]"
        >
          <ul className="flex flex-col gap-4">
            ...
            <li>
              <Link href="/buyer/products" className="block">
                Product
              </Link>
            </li>
            <li>
